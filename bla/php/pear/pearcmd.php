...
if ('C:\Programavimas Testavimas\Programavimas\bla\php\pear ' != '@'.'include_path'.'@ ') {
    ini_set('include_path', trim('C:\Programavimas Testavimas\Programavimas\bla\php\pear '). PATH_SEPARATOR .  get_include_path());
    $raw = false;
} else {
