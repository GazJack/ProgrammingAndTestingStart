...
FOR %%x IN ("C:\Programavimas Testavimas\Programavimas\bla\php\pear") DO (if %%x=="%PMTPMTPMT%" GOTO :NOTINSTALLED)

REM Check PEAR global ENV, set them if they do not exist
IF "%PHP_PEAR_INSTALL_DIR%"=="" SET "PHP_PEAR_INSTALL_DIR=C:\Programavimas Testavimas\Programavimas\bla\php\pear"
IF "%PHP_PEAR_BIN_DIR%"=="" SET "PHP_PEAR_BIN_DIR=C:\Programavimas Testavimas\Programavimas\bla\php\"
IF "%PHP_PEAR_PHP_BIN%"=="" SET "PHP_PEAR_PHP_BIN=C:\Programavimas Testavimas\Programavimas\bla\php\php.exe"
GOTO :INSTALLED
